...
public class ControllerLogAspect {
    ...
    @Pointcut("within(com.zyiot.controller..*)")
    public void inController() {
    }

    @Pointcut("execution(public * com.zyiot.controller..*.*(..))")
    ...
    public Object around(ProceedingJoinPoint jp) {
        ...
        try {
            ...
            logger.error("exception when do :" + declaringTypeName + "." + signatyreName + " params:" + JSON.toJSONString(args));
            logger.error("异常：" + e);
        } finally {
